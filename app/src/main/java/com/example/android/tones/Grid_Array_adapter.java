...
public class Grid_Array_adapter extends ArrayAdapter<Array_Audio> {
    private String name;
    Grid_Array_adapter(Activity context, ArrayList<Array_Audio> list) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        Glide.with(getContext()).asBitmap().load(array_audio.getmAlbum_cover()).into(image);
